...
const RowSection: React.FC<RowSectionProps> = ({ children, className, fullWidth, alignItems, noMargin, mt, mb }) => {
  return (
   <Row className={className} fullWidth={fullWidth} alignItems={alignItems} noMargin={noMargin} mt={mt} mb={mb}>
      {children}
   </Row>
  )
}
